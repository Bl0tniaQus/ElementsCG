...
Deck::Deck(short deckid)
{
    if (deckid==1)
    {
        ...
        this->mainDeck[1] = Card(7);
        this->mainDeck[2] = Card(6);
        this->mainDeck[3] = Card(7);
        this->mainDeck[4] = Card(5);
        this->mainDeck[5] = Card(4);
        this->mainDeck[6] = Card(6);
        this->n_cards = 7;
        for (int i=0;i<this->n_cards;i++)
        {
            this->mainDeck[i].setPlace(0);
    ...
    if (deckid==2)
    {
        ...
        this->mainDeck[2] = Card(6);
        this->mainDeck[3] = Card(2);
        this->mainDeck[4] = Card(6);
        this->mainDeck[5] = Card(5);
        this->mainDeck[6] = Card(7);
        this->n_cards = 7;
        for (int i=0;i<this->n_cards;i++)
        {
            this->mainDeck[i].setPlace(0);
